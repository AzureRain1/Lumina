...
namespace SaintCoinach.Graphics.Sgb {
    public class SgbFile {
        ...
        public GameData LuminaData { get; private set; }
        public byte[] Buffer { get; private set; }
        #endregion

        #region Constructor
        public SgbFile( GameData gameData, byte[] rawData )
        {
            //public SgbFile(IO.File file) {
            //this.File = file;
            this.LuminaData = gameData;
            this.Buffer = rawData;
            Build();
        }
        #endregion
        ...
        private void Build() {
            ...
            this.Header = this.Buffer.ToStructure<HeaderData>(0);
            ...
            try {
                data.Add(new SgbGroup(this, this.Buffer, BaseOffset + Header.SharedOffset));
                data.Add(new SgbGroup(this, this.Buffer, BaseOffset + Header.Offset1C, true));
