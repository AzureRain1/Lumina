            ...
            if (isOffset1C) {
                ...
                for (var i = 0; i < count; ++i) {
                    try {
                        ...
                        Entries[i] = new SgbGroup1CEntry(parent.LuminaData, buffer, entryOffset);
                        break;
                    }
                    catch (Exception e) {
                    ...
                    try {
                        ...
                        switch (type) {
                            case SgbGroupEntryType.Model:
                                Entries[i] = new SgbModelEntry(Parent.LuminaData, buffer, entryOffset);
                                break;
                            case SgbGroupEntryType.Gimmick:
                                Entries[i] = new SgbGimmickEntry(Parent.LuminaData, buffer, entryOffset);
                                break;
